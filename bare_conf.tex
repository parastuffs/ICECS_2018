...
% in the abstract
\begin{abstract}
In 3D ICs, we superpose layers of gates in order to reduce the total 3D wire-length.
When partitioning a system, arises the question of the grain at which it should be considered to optimize the gains.
In this work, we study designs ranging from 42k gates to 800k gates and cluster them from 8 to 32768 portions.
We find that with 2048 clusters, i.e. from 20 to 400 gates depending on the design, a partitioning of the system allows on average to cut 35\% of the nets and to consider 73\% of the total wire-length in 3D.
\end{abstract}
