...
As of today there is no full support for 3D integration in commercial EDA tools. Rather, various extensions to existing 2D Place\&Route (P\&R) tools have been proposed in academia and industrial R\&D. Work of Sung-kuy. Extension of such approach with improved 3D PPA has been proposed in ~\cite{Chang2016}. % Cascade2D
