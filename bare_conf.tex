...
% affiliations
\author{\IEEEauthorblockN{Michael Jackson}
\IEEEauthorblockA{School of Electrical and\\Computer Engineering\\
Georgia Institute of Technology\\
Atlanta, Georgia 30332--0250\\
Email: http://www.michaelshell.org/contact.html}
\and
\IEEEauthorblockN{Harry ``The Mad Wizard'' Potter}}
...
Significant effort have already been made in order to develop a full-fledged 3D EDA toolchain, such as~\cite{Chang2016}. % Cascade2D

The clustering problem has aslo been studied at other step of the design, such as during the P\&R step~\cite{Moura2017}. % ICECS2016 clustering
...
From there, the translation to a hypergraph $\mathcal{H}$ is immediate: let $\mathcal{H} = (V, H)$ be an association between the set of vertices $V$ (\textit{e.g.} the gates) and the set of hyperedges $H$ (\textit{e.g.} the nets). % Do I need to explain what a hypergraph is?
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=\linewidth]{prop-3Dwl-wrt-design-prop-gate-per-clusters-maxcut.png}
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=\linewidth]{prop-3Dwl-wrt-design_prop-gate-per-clusters_maxcutv2.png}
%\caption{The total 3D wire-length increases when the amount of gate per cluster decreases, until it reaches a threshold.}
%\label{fig:3Dwl}
%\end{figure}
...
\caption{Distribution of the percentage of cut wire per logarithmic quartile of their wire-length relative to the longest net.}
